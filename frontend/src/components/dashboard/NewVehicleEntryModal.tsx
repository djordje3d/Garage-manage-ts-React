...
export function NewVehicleEntryModal({
  ...
  useEffect(() => {
    ...
    resetSpots();
  }, [modelValue, loadVehicleTypesAndGarages, resetSpots, setOptionsError]);
  ...
  return (
    <Modal
      ...
      onModelValueChange={(open) => {
        if (!open) close();
      }}
    >
      <form
        className="entry-form w-full"
        onSubmit={(ev) => {
          void submit(ev);
        }}
      >
        <div className="space-y-4">
          ...
          <div>
            <StandardDropdown
              ...
              modelValue={form.vehicle_type_id || null}
          ...
          <div>
            <StandardDropdown
              ...
              modelValue={form.garage_id || null}
